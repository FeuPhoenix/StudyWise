...
class Video_Processed_Controller:
    @staticmethod  
    def fetch_all_filenames_in_Video_material(userid):
    ...
    def retrieveVideoMaterialFromFirestore(user_id, material_id):
        ...
        try:
            ...
            if doc.exists:
                ...
                return video_material_data['_file_path'],video_material_data['generated_audio_file_path'],Summary,Chapters,flashcards,MCQ_E,MCQ_M,MCQ_H
            else:
