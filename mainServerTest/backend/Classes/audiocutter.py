...
import time
import shutil
TEMP_FOLDER = "mainServerTest/assets/output_files/Temp_Files/TEMP" 
...
INPUT_FILE = "mainServerTest/assets/input_files/video/Speech_to_Text_using_Python_-_Fast_and_Accurate-(144p).mp4"
start_time = time.time()
...
def runaudiocutter(INPUT_FILE):
    ...
    FILE_NAME= getFileNameFromPathWithOutExtension(INPUT_FILE)
